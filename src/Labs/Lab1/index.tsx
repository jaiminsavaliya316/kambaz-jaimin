  ...
  return (
    <div id="wd-lab1">
      ...
      <div id="wd-lists">
        ...
        My favorite recipe: Spicy egg fried rice
        <ol id="wd-your-favorite-recipe">
          <li>Sorte onions, pepper, any veggies with spices</li>
          <li>Move cooked things to the one side of the pan and cook eggs on emptied part of the pan</li>
          <li>Same as above, move things to the side of pan and make space for rice</li>
          <li>Add oil, soy sauce, add cooked rice, mix everything</li>
        </ol>
        ...
        <h5>Unordered List Tag</h5>
          ...
          <ul id="wd-your-books">
            ...
            <li>Nisekoi</li>
            <li>Subtle art of not caring</li>
          </ul>
    ...
    {/* This section contains image logic */}
      <div id="wd-images">
        <h4>Image tag</h4>
    ...
    {/* This sections contains form section */}
    <div id="wd-forms">
      <h4>Form Elements</h4>
    ...
    {/* This section contains Textarea */}
    <div>
      <h5>Text boxes</h5>
    ...
    <div>
      ...
      <div>
        ...
        Please
        <a href="https://github.com/jaiminsavaliya316/kambaz-jaimin" id="wd-github">click here</a>
        to visit m github repo<br/>
      </div>
